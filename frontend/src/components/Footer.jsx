    ...
    <div className="footer-wrapper container-fluid mx-10">
      <div className="grid grid-cols-12 gap-1.5">
        <div className="col-span-12 sm:col-span-6 my-1">
          <p className="m-0" />Able Pro ♥ crafted by Team <a href="https://themeforest.net/user/phoenixcoded" className="text-theme-bodycolor dark:text-themedark-bodycolor hover:text-primary-500 dark:hover:text-primary-500" target="_blank">Phoenixcoded</a>
          <p />
        </div>
        <div className="col-span-12 sm:col-span-6 my-1">
